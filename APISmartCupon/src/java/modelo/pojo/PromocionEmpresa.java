...
public class PromocionEmpresa {
    ...
    public PromocionEmpresa() {
    }

    public PromocionEmpresa(Integer idPromocion, String empresa, String nombrePromocion, String descripcion, String imagenPromocionBase64, String fechaInicioPromocion, String fechaTerminoPromocion, String restricciones, Integer idTipoPromocion, Integer porcentaje_Costo, Integer idCategoria, int cuponesMaximos, String codigoPromocion, byte[] imagenPromocion, boolean estatus) {
