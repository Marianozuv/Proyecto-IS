 ...
 * @author mateo
 */
public class FXMLFormSucursalComercialController implements Initializable {

    private Sucursal sucursal;
    private ObservableList<Empresa> empresas;
    private FXMLModuloSucursalComercialController moduloSucursalController;
    ...
    public void setModuloSucursalComercialController(FXMLModuloSucursalComercialController controller) {
