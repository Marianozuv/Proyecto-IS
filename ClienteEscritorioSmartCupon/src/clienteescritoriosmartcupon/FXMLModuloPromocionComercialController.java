 ...
 * @author mateo
 */
public class FXMLModuloPromocionComercialController implements Initializable {
    ...
    void obtenerPromociones(int idEmpresa) {
        try {
            ...
            List<Promocion> info = PromocionDAO.obtenerPromocionesByEmpresa(idEmpresa);
    ...
    private void btVerInfoPromocion(ActionEvent event) throws IOException {
        ...
        if (posicionSeleccionada != -1) {
            ...
            FXMLLoader vistaLoad = new FXMLLoader(getClass().getResource("FXMLFormPromocionComercial.fxml"));
            Parent vista = vistaLoad.load();

            FXMLFormPromocionComercialController controller = vistaLoad.getController();
